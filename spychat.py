...
bbtn = Button(tab1,text = "Search Image",fg = 'powder blue',bg = 'black',width = 20,bd = 15,command = lambda: browse())
...
reset = Button(tab1,text = "Clear",fg = 'powder blue',bg = 'black',command = lambda: clear(path_entry),bd = 15)
...
enc = Button(tab1,text = "Encode" ,fg = 'powder blue',bg = 'black', bd =15,command = lambda: hide_msg(path_entry.get(),sms.get()))
enc.place(relx = 0.4,rely = 0.85)

upload_btn = Button(tab1 , text = "Upload",fg = 'powder blue',bg = 'black',bd = 15,command = lambda : image(path_entry.get()))
...
bbtn2 = Button(tab2,text = "Search Image",fg = 'powder blue',bg = 'black',width = 20,bd = 15,command = lambda: browses())
...
msg = Button(tab2 , text = "View Message",fg = 'powder blue',bg = 'black',bd = 15, command = show_details).place(relx = 0.35,rely = 0.38)
